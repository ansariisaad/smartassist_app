...
class AppointmentAdminAll extends StatefulWidget {
  ...
  @override
  State<AppointmentAdminAll> createState() => _AllFollowupsItemState();
}

class _AllFollowupsItemState extends State<AppointmentAdminAll>
...
class AllOppintmentAdmin extends StatefulWidget {
  final List<dynamic> allFollowups;
  final bool isNested;

  const AllOppintmentAdmin({
    super.key,
  ...
  @override
  State<AllOppintmentAdmin> createState() => _AllOppintmentAdminState();
}

class _AllOppintmentAdminState extends State<AllOppintmentAdmin> {
  ...
  @override
  void didUpdateWidget(AllOppintmentAdmin oldWidget) {

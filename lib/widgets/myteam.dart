...
class _MyteamState extends State<Myteam> {
  ...
  Future<Map<String, dynamic>> fetchTeamComparisonData() async {
    try {
      ...
      Uri url = Uri.parse(
        'https://api.prod.smartassistapp.in/api/users/sm/dashboard/team-comparison$periodParam',
      );
  ...
  Future<void> _fetchAllTeamPerformance() async {
    try {
      ...
      final response = await http.get(
        Uri.parse(
          'https://api.prod.smartassistapp.in/api/users/sm/dashboard/all-performance',
        ),
        headers: {
          'Authorization': 'Bearer $token',
          'Content-Type': 'application/json',
  ...
  Future<Map<String, dynamic>> _fetchDataUserProfile() async {
    try {
      ...
      final response = await http.get(
        Uri.parse(
          'https://api.prod.smartassistapp.in/api/users/sm/dashboard/individual-performance',
        ),
        headers: {
          'Authorization': 'Bearer $token',
          'Content-Type': 'application/json',
  ...
  Future<void> _fetchIndividualPerformance(String userId) async {
    try {
      ...
      final response = await http.get(
        Uri.parse(
          'https://api.prod.smartassistapp.in/api/users/sm/dashboard/individual-performance?user_id=$userId',
        ),
        headers: {
          'Authorization': 'Bearer $token',
          'Content-Type': 'application/json',

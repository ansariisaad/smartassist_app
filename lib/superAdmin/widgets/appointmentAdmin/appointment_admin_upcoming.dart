...
class AppointmentAdminUpcoming extends StatefulWidget {
  final Future<void> Function() refreshDashboard;
  final List<dynamic> upcomingOpp;
  final bool isNested;
  final Function(String, bool)? onFavoriteToggle;
  const AppointmentAdminUpcoming({
    super.key,
  ...
  @override
  State<AppointmentAdminUpcoming> createState() => _AppointmentAdminUpcomingState();
}

class _AppointmentAdminUpcomingState extends State<AppointmentAdminUpcoming> {
  ...
  void initState() {
    ...
    _currentDisplayCount = math.min(_incrementCount, widget.upcomingOpp.length);

...
class ThreebtnAdmin extends StatefulWidget {
  ...
  @override
  State<ThreebtnAdmin> createState() => _ThreebtnAdminState();
}

class _ThreebtnAdminState extends State<ThreebtnAdmin> {
  ...
  @override
  void didUpdateWidget(ThreebtnAdmin oldWidget) {
  ...
  bool _hasDataChanged(ThreebtnAdmin oldWidget) {

...
//                   index: 2,
//                   // isIcon: true,
//                   img: Image.asset('assets/calendar.png', fit: BoxFit.contain), context: (context),
//                 ),
//               );
//             } else {
//               navItems.add(
...
//               return Row(
//                 mainAxisAlignment: MainAxisAlignment.spaceAround,
//                 children: navItems.map((item) => Flexible(child: item)).toList(),
//               );
//             }),
//           ),
//         ),
...
//     final maxHeight = calculatedHeight > minHeight ? calculatedHeight : minHeight;

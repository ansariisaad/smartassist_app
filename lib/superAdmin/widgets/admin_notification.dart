...
class _AdminNotificationState extends State<AdminNotification> {
  ...
  Future<void> _fetchNotifications({String? category}) async {
    ...
    String url =
        'https://dev.smartassistapp.in/api/app-admin/notifications/all?userId=$adminId&';
    //  'https://dev.smartassistapp.in/api/users/notifications/all';
  ...
  Future<void> markAsRead(String id) async {
    final token = await Storage.getToken();
    final url = 'https://dev.smartassistapp.in/api/users/notifications/$id';
    try {

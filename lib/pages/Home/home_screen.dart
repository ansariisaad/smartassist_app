...
//         try {
//           await fetchDashboardData();
//           await _loadDashboardAnalytics();
//           await _loadTeamRole();
          
//           // Add delay before permission request to avoid conflicts
...
//   // Fixed call log after login with proper permission handling
//   Future<void> uploadCallLogsAfterLogin() async {
...
//         print('Phone permission permanently denied. Please enable in settings.');
//         // Optionally show dialog to open app settings
//         // await openAppSettings();
//       }
//     } on PlatformException catch (e) {
//       if (e.message?.contains('already running') == true) {
//         print('Permission request already in progress, will retry later');
//         // Retry after a delay
//         Future.delayed(const Duration(seconds: 3), () {
//           uploadCallLogsAfterLogin();
//         });
//       } else {
//         print('Platform exception during permission request: $e');
//       }
//     } catch (e) {
...
//   // Extract call log processing into separate method
...
//       }
//     } catch (e) {
//       print('Call log processing error: $e');
//     }
//   }
...
//   Future<void> onrefreshToggle() async {
//     await fetchDashboardData();
//     // Add delay before calling upload to prevent permission conflicts

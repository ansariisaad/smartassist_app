...
class _LeadsearchTestdriveState extends State<LeadsearchTestdrive> {
  ...
  //   final vehicleId = lead['vehicleId']?.toString() ?? '';
  //   setState(() {
  //     FocusScope.of(context).unfocus();
  //     selectedLeads = leadId;
  //     selectedLeadsName = leadName;
  ...
  //     // Set PMI as placeholder but don't trigger search automatically
  //     // Auto-fill vehicle search with PMI but don't trigger search automatically
  //     if (pmi != null && pmi.isNotEmpty) {
  //       _searchController1.text = pmi;
  //       _isVehicleSearchActive = false; // Don't trigger search yet
  //     } else {
  //       _searchController1.text = '';
  //     }
  //   });
  ...
  //     //   'You can search for vehicles or use PMI: $pmi',

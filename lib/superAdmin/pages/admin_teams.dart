...
class _AdminTeamsState extends State<AdminTeams> {
  ...
  Future<void> _fetchSingleCalllog() async {
    try {
      ...
      final baseUri = Uri.parse(
        'https://api.prod.smartassistapp.in/api/app-admin/call/analytics',
      );
  ...
  Future<void> _fetchAllCalllog() async {
    ...
    try {
      ...
      // final baseUri = Uri.parse(
      //   'https://api.prod.smartassistapp.in/api/app-admin/SM/team-calls?userId=$userId',
      // );
  ...
  Future<void> _fetchTeamDetails() async {
    try {
      ...
      final baseUri = Uri.parse(
        'https://api.prod.smartassistapp.in/api/app-admin/SM/dashboard',
      );
  ...
  //       'https://api.prod.smartassistapp.in/api/app-admin/SM/dashboard?userId=$adminId',
  //     );

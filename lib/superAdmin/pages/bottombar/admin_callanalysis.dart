...
class _CallAnalyticsState extends State<AdminCallanalysis>
  ...
  Future<void> _fetchDashboardData() async {
    try {
      ...
      if (widget.isFromSM) {
        uri = Uri.parse(
          'https://api.prod.smartassistapp.in/api/app-admin/call/analytics?userId=$adminId&$periodParam&user_id=${widget.userId}',
        );
      } else {
        uri = Uri.parse(
          'https://api.prod.smartassistapp.in/api/app-admin/call/analytics?userId=$adminId&$periodParam',
        );
      }

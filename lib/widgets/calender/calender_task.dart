...
class _CalenderTaskState extends State<CalenderTask> {
  ...
  DateTime _parseTimeString(String timeStr) {
    ...
    if (parts.length == 3) {
      try {
        ...
        return DateTime(
          ...
          minute,
          second,
        ); // Use a dummy date (e.g., 2022-01-01)
      } catch (e) {
        return DateTime(
          2022,
          1,
    ...
    return DateTime(
      ...
      0,
      0,
    ); // Default to midnight if the time format is incorrect
  }
      ...
      builder: (context, snapshot) {
        ...
        if (widget.tasks.isEmpty) {
          return SizedBox(
            ...
            child: Center(
              child: Text(
                'No Task available for ${DateFormat('MMMM dd').format(widget.selectedDate)}.',
              ),
            ),
          );
        }
              ...
              return Column(
                ...
                children: [
                  ...widget.tasks.map((appointment) {
                    print(
                      appointment,
                    ); // Add a print statement to see each appointment's data
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        appointment['start_time'] != null
                                            ...
                                            : 'No start time',
                                        style: GoogleFonts.poppins(
                                          fontSize: screenWidth > 600 ? 16 : 10,
                                        ),
                                      ),

...
//     if (activeTimeSlots.isEmpty) {
//       return Expanded(
//         child: _emptyState('No scheduled activities for this date'),
//       );
//     }
...
//       return Color(0xFF4A90E2).withOpacity(0.13);
//     }
//     if (c.contains('call') ||
...
//         c.contains('followup')) {
//       return Color(0xFFF865AB).withOpacity(0.16);
//     }

...
//         setState(
//           () => _permissionsGranted =
//               micStatus.isGranted && speechStatus.isGranted,
//         );
//       } else {
//         if (micStatus.isGranted) {
//           setState(() => _permissionsGranted = true);
...
//         setState(() => _permissionsGranted = micStatus.isGranted);
//       }
...
//       bool started = true; // Assume started since we waited
//     } catch (e) {
...
//         tooltip: 'Grant microphone permission',
//       );
//     }
...
//         _startForceStopTimer();
//       } else {
//         debugPrint('Failed to start speech listening');
